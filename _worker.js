...
// Variables
const rootDomain = "d2vpnstore.my.id"; // Ganti dengan domain utama kalian
const serviceName = "dede"; // Ganti dengan nama workers kalian
const apiKey = "u-e0UoCv0Y8eK9QyJXyWHPank79PLbyqr7wQhh--"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "dsulaeman994@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "1b4a3dabe46ca0ac57574d149c8f9ea4"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "afab9d6a84d9591fb26a1e6b518a50ca"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
